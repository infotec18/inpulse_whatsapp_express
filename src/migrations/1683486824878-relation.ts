...
export class Relation1683486824878 implements MigrationInterface {
    name = 'Relation1683486824878'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`atendimentos\` (\`CODIGO\` int NOT NULL AUTO_INCREMENT, \`CODIGO_OPERADOR\` int NOT NULL, \`CODIGO_CLIENTE\` int NOT NULL, \`CODIGO_NUMERO\` int NOT NULL, \`CONCLUIDO\` tinyint NULL DEFAULT '0', \`DATA_INICIO\` datetime NULL, \`DATA_FIM\` datetime NULL, \`DATA_AGENDAMENTO\` datetime NULL, \`URGENCIA\` enum ('URGENTE', 'ALTA', 'NORMAL') NOT NULL DEFAULT 'NORMAL', PRIMARY KEY (\`CODIGO\`)) ENGINE=InnoDB`);
