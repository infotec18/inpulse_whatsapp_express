...
export class firstMigration1681132580879 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`atendimentos\` (\`CODIGO\` int NOT NULL AUTO_INCREMENT, \`CODIGO_OPERADOR\` int NULL, \`CODIGO_CLIENTE\` int NOT NULL, \`CODIGO_NUMERO\` int NOT NULL, \`CONCLUIDO\` tinyint DEFAULT '0', \`DATA_INICIO\` datetime NULL, \`DATA_FIM\` datetime NULL, \`DATA_AGENDAMENTO\` datetime NULL, \`URGENCIA\` enum ('URGENTE', 'ALTA', 'NORMAL') NOT NULL DEFAULT 'NORMAL', UNIQUE INDEX \`IDX_7f646676c743c35161772545a8\` (\`CODIGO_OPERADOR\`), UNIQUE INDEX \`IDX_2942751d1af49f32a6540b8aa7\` (\`CODIGO_CLIENTE\`), UNIQUE INDEX \`IDX_e96b07a3b03f5cdd5901595663\` (\`CODIGO_NUMERO\`), PRIMARY KEY (\`CODIGO\`)) ENGINE=InnoDB`);
